...
export function ExportMenu({ result, prepareForPdf }: Props) {
  ...
  async function downloadPdf() {
    ...
    try {
      ...
      // Landscape A4 — naturally fits the wide 2-column magazine layout
      const pdf = new jsPDF({ unit: 'mm', format: 'a4', orientation: 'landscape' });
      const pageWidthMm = pdf.internal.pageSize.getWidth(); // 297 in landscape
      const pageHeightMm = pdf.internal.pageSize.getHeight(); // 210 in landscape
