  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-md bg-paper/80 border-b border-ink/10">
      <nav className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1 font-elite text-[12px] uppercase tracking-wider text-ink-soft">
        ...
        <div className="flex items-center gap-2">
          <Link href="/login" className="btn-ghost text-xs uppercase">sign in</Link>
          <Link href="/app" className="btn-primary text-xs">Try free</Link>
        </div>
      </nav>
    </header>
  );
